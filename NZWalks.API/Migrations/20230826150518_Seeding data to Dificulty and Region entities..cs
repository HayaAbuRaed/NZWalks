...
{
    /// <inheritdoc />
    public partial class SeedingdatatoDificultyandRegionentities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0a29aef4-b310-4437-b1bb-6de435275de5"), "Medium" },
                    { new Guid("4fa2a0da-9c9e-4966-80be-169aa65d5d16"), "Hard" },
                    { new Guid("7c6e16b2-dfde-4f6d-950b-81a63e25397a"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0a29aef4-b310-4437-b1bb-6de435275de5"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("4fa2a0da-9c9e-4966-80be-169aa65d5d16"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("7c6e16b2-dfde-4f6d-950b-81a63e25397a"));
